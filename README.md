...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://www.heroku.com/deploy?template=https://github.com/dlbot/Zee5-Downloader)
...
```sh
git clone https://github.com/Zee5-DL/Zee5-Downloader
cd Zee5-Downloader
